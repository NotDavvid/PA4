...
main(int argc, char *argv[])
{
  ...
  2f:	68 68 07 00 00       	push   $0x768
  34:	6a 01                	push   $0x1
  36:	e8 e5 03 00 00       	call   420 <printf>
	exit();
  3b:	e8 82 02 00 00       	call   2c2 <exit>
{
	int n=23;
	int counts[n];
	printf(1, "Davvid_Caballero_#A20307530\n");
  ...
  46:	e8 05 02 00 00       	call   250 <atoi>
  ...
  52:	6a 17                	push   $0x17
  54:	50                   	push   %eax
  55:	e8 08 03 00 00       	call   362 <getcount>
		printf(1, "count: %d\n", counts[arg]);
  5a:	83 c4 0c             	add    $0xc,%esp
  5d:	ff 74 9d 8c          	pushl  -0x74(%ebp,%ebx,4)
  61:	68 5d 07 00 00       	push   $0x75d
  66:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 c4 08 00 00 	movzbl 0x8c4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 bc 08 00 00       	mov    $0x8bc,%eax
...
free(void *ap)
{
 ...
 5c1:	a1 64 0b 00 00       	mov    0xb64,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 64 0b 00 00       	mov    %eax,0xb64
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 64 0b 00 00       	mov    %eax,0xb64
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 64 0b 00 00    	mov    0xb64,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6af:	76 3f                	jbe    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	39 05 64 0b 00 00    	cmp    %eax,0xb64
 ...
 6d6:	e8 e5 fe ff ff       	call   5c0 <free>
  return freep;
 6db:	8b 15 64 0b 00 00    	mov    0xb64,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ff:	89 15 64 0b 00 00    	mov    %edx,0xb64
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 64 0b 00 00 68 	movl   $0xb68,0xb64
 71d:	0b 00 00 
 720:	c7 05 68 0b 00 00 68 	movl   $0xb68,0xb68
 727:	0b 00 00 
    base.s.size = 0;
 72a:	b8 68 0b 00 00       	mov    $0xb68,%eax
 72f:	c7 05 6c 0b 00 00 00 	movl   $0x0,0xb6c
 736:	00 00 00 
