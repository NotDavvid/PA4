...
_kernelm:     file format elf32-i386
...
main(int argc, char *argv[])
{
  11:	83 ec 1c             	sub    $0x1c,%esp
	...
	int finals=0;	
	pages[1]=3;
  14:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%ebp)
	currentm(pages, finals);
  1b:	6a 00                	push   $0x0
  1d:	50                   	push   %eax
  1e:	e8 07 03 00 00       	call   32a <currentm>
	printf(1, "Kernel: %d\n", pages[1]/PGSIZE);
  23:	8b 45 f4             	mov    -0xc(%ebp),%eax
  26:	83 c4 0c             	add    $0xc,%esp
  29:	c1 e8 0c             	shr    $0xc,%eax
  2c:	50                   	push   %eax
  2d:	68 00 07 00 00       	push   $0x700
  32:	6a 01                	push   $0x1
  34:	e8 a7 03 00 00       	call   3e0 <printf>
	exit();
  39:	e8 44 02 00 00       	call   282 <exit>
  3e:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 4f8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4fb:	b8 0c 07 00 00       	mov    $0x70c,%eax
