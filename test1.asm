...
main(int argc, char *argv[])
{
  ...
  18:	e8 c3 03 00 00       	call   3e0 <printf>
	malloc(N);
  1d:	c7 04 24 8b 4a 8d 77 	movl   $0x778d4a8b,(%esp)
  24:	e8 e7 05 00 00       	call   610 <malloc>
	currentm();
  29:	e8 fc 02 00 00       	call   32a <currentm>
    	exit();
  2e:	e8 4f 02 00 00       	call   282 <exit>
  33:	66 90                	xchg   %ax,%ax
  35:	66 90                	xchg   %ax,%ax
  37:	66 90                	xchg   %ax,%ax
  39:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 4f8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4fb:	b8 0d 07 00 00       	mov    $0x70d,%eax
